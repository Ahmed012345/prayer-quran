...
package com.zaker.android.sapeh.data.database;
...
import com.zaker.android.sapeh.BuildConfig;
...
public abstract class DataSource<T> {
	...
	/**
	 * Convert item into {@link ContentValues ContentValues}
	 * @param item Item to convert
	 * @return Converted item into {@link ContentValues ContentValues}.
	 */
	...
	/**
	 * Convert {@link Cursor Cursor} into item T
	 * @param cursor Cursor.
	...
	/**
	 * Convert one record of {@link Cursor Cursor} into item T
