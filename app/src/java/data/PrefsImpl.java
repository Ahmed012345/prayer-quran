...
public class PrefsImpl implements Prefs {
	...
	private static final String PREF_NAME = "com.zaker.android.sapeh.data.PrefsImpl";
...
//		setStoreDirPublic(true);
	...
	public int getFormat() {
		return sharedPreferences.getInt(PREF_KEY_FORMAT, AppConstants.RECORDING_FORMAT_MP3);
	}
