...
public class Activity34List extends SlidingUpBaseActivity<ObservableScrollView>
        implements ObservableScrollViewCallbacks {

    Context context = this;
    MediaPlayer backb,finalpop;
    Toolbar toolbar;
    ...
    ImageView img1,img2;
    BubbleLayout kal,kal1,kal2,kal3,kal4,kal5,kal6,kal7,kal8,badge;
    ...
    protected int getLayoutResId() {
        return R.layout.activity34_list;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onBackPressed();
                MaterialToast.makeText(Activity34List.this, getResources().getString(R.string.bybyback), R.mipmap.ic_kaba1,
        ...
        po_image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image1.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity34List.this, getResources().getString(R.string.surah21), FloatingToast.LENGTH_TOO_LONG)
        ...
        shapeDrawable.setColor(getResources().getColor(R.color.md_purple_600));
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                CookieBar.build(Activity34List.this)
            ...
            public void onFinish(long recordTime) {
                ...
                new MaterialToast(context)
                        ...
                        .setBackgroundColor(getResources().getColor(R.color.e35))
                        .show();
