...
public class Activity2List extends SlidingUpBaseActivity<ObservableScrollView>
    ...
    ImageView img1,img2;
    BubbleLayout kal,kal1,kal2,kal3,kal4,kal5,kal6,kal7,kal8,kal9,kal10,kal11,kal12,badge,badge1;
    FloatingActionButton fab;


    @Override
    protected int getLayoutResId() {
        return R.layout.activity2_list;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m1 = MediaPlayer.create(this, R.raw.yo1sof33);
        m2 = MediaPlayer.create(this, R.raw.yo1sef101);
        ...
        po_image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image1.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity2List.this, getResources().getString(R.string.surah12), FloatingToast.LENGTH_TOO_LONG)
                            ...
                            .setTextColor(Color.parseColor("#61A2DA"))
        ...
        po_image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image2.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity2List.this, getResources().getString(R.string.z33), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setBackgroundBlur(true)
        ...
        po_image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image3.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity2List.this, getResources().getString(R.string.z101), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setBackgroundBlur(true)
        ...
        po_image4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                po_image4.setChecked(false);
                if (m1.isPlaying()) {
                    m1.stop();
                    m1.prepareAsync();
                    m1.seekTo(0);
                    FloatingToast.makeToast(Activity2List.this, getResources().getString(R.string.stop), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setBackgroundBlur(true)
                    ...
                    po_image4.setChecked(true);
                    m1.start();
                    FloatingToast.makeToast(Activity2List.this, getResources().getString(R.string.play), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setBackgroundBlur(true)
                            ...
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
                            .setShadowLayer(5, 1, 1, Color.parseColor("#61A2DA"))
                            .show();    //Show toast at the specified fixed position
                    if (m2.isPlaying()) {
                        m2.stop();
                        m2.prepareAsync();
                    ...
                    if (po_image5.isChecked())po_image5.setChecked(false);
        ...
        po_image5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (m2.isPlaying()) {
                    ...
                    if (po_image4.isChecked())po_image4.setChecked(false);
        ...
        shapeDrawable.setColor(getResources().getColor(R.color.shape2));
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                CookieBar.build(Activity2List.this)
                        ...
                        .setBackgroundColor(R.color.bolo)
            ...
            public void onFinish(long recordTime) {
                ...
                new MaterialToast(context)
                        ...
                        .setBackgroundColor(R.color.shape2)
                        .show();
        ...
        kal12 = findViewById(R.id.kal12); badge = findViewById(R.id.badge); badge1 = findViewById(R.id.badge1);
        ...
        new ClickShrinkEffect(kal12); new ClickShrinkEffect(badge);
        new ClickShrinkEffect(badge1); new ClickShrinkEffect(img1);
