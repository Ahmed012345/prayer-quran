...
public class Activity27List extends SlidingUpBaseActivity<ObservableScrollView>
        implements ObservableScrollViewCallbacks {

    Context context = this;
    MediaPlayer m1,m2,m3,m4,m5,m6,m7,m8,backb,finalpop;
    Toolbar toolbar;
    ...
    ShineButton po_image,po_image1,po_image2,po_image3,po_image4,po_image5,
            ...
            po_image19,po_image20,po_image21;


    RecordView recordView;
    RecordButton recordButton;
    ImageView img1,img2;
    BubbleLayout kal,kal1,kal2,kal3,kal4,kal5,kal6,kal7,kal8,kal9,badge,badge1,badge2,badge3,badge4,badge5,badge6,badge7,
            badge8,badge9,badge10,badge11,badge12,badge13,badge14,badge15,badge16,badge17;
    FloatingActionButton fab;

    @Override
    protected int getLayoutResId() {
        return R.layout.activity27_list;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onBackPressed();
                new MaterialToast(Activity27List.this)
        ...
        m1 = MediaPlayer.create(this, R.raw.b21ra200202);
        m2 = MediaPlayer.create(this, R.raw.b21ara285286);
        m3 = MediaPlayer.create(this, R.raw.al1emran1617);
        m4 = MediaPlayer.create(this, R.raw.al1iemran191194);
        m5 = MediaPlayer.create(this, R.raw.al1for2an6366);
        m6 = MediaPlayer.create(this, R.raw.al1for2an74);
        m7 = MediaPlayer.create(this, R.raw.at1hrim8);
        m8 = MediaPlayer.create(this, R.raw.mo1emnon109);
        ...
        po_image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image1.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.sourah2), FloatingToast.LENGTH_TOO_LONG)
                            ...
                            .setTextColor(Color.parseColor("#A4804C"))
        ...
        po_image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image2.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z200202), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image3.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z285286), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image4.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.sourah3), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image5.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z1617), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image6.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z191194), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image7.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.sourah25), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image8.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z6366), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image9.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z74), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image10.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.sourah66), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image11.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z8), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image12.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.sourah23), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image13.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.z109), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (m1.isPlaying()) {
                    ...
                    m1.prepareAsync();
                    m1.seekTo(0);
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.stop), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
                    ...
                    m1.start();
                    FloatingToast.makeToast(Activity27List.this, getResources().getString(R.string.play), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
                            ...
                            .setShadowLayer(5, 1, 1, Color.parseColor("#A4804C"))
                            .show();    //Show toast at the specified fixed position
                    if (m2.isPlaying()) {
                        m2.stop();
                        m2.prepareAsync();
        ...
        shapeDrawable.setColor(getResources().getColor(R.color.shape27));
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                CookieBar.build(Activity27List.this)
                        .setTitle(getResources().getString(R.string.hold_button_to_record))
                        .setTitleColor(R.color.al2727)
                        ...
                        .setBackgroundColor(R.color.al27272727)
            ...
            public void onFinish(long recordTime) {
                ...
                new MaterialToast(context)
                        ...
                        .setBackgroundColor(getResources().getColor(R.color.shape27))
                        .show();
        ...
        kal9 = findViewById(R.id.kal9); badge = findViewById(R.id.badge); badge1 = findViewById(R.id.badge1);
        ...
        badge17 = findViewById(R.id.badge17); img1 = findViewById(R.id.img1); img2 = findViewById(R.id.img2);
