...
public class Activity25List extends SlidingUpBaseActivity<ObservableScrollView>
    ...
    ImageView img1,img2;
    BubbleLayout kal,kal2,kal3,kal4,kal5,kal6,kal7,kal8,badge;
    FloatingActionButton fab;

    @Override
    protected int getLayoutResId() {
        return R.layout.activity25_list;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onBackPressed();
                new MaterialToast(Activity25List.this)
        ...
        m1 = MediaPlayer.create(this, R.raw.aa1raf47);
        ...
        po_image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image1.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity25List.this, getResources().getString(R.string.surah7), FloatingToast.LENGTH_TOO_LONG)
                            ...
                            .setTextColor(Color.parseColor("#C1395E"))
        ...
        po_image2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (po_image2.isChecked()){
                    finalpop.start();
                    FloatingToast.makeToast(Activity25List.this, getResources().getString(R.string.z47), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
        ...
        po_image3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (m1.isPlaying()) {
                    ...
                    m1.prepareAsync();
                    m1.seekTo(0);
                    FloatingToast.makeToast(Activity25List.this, getResources().getString(R.string.stop), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
                    ...
                    m1.start();
                    FloatingToast.makeToast(Activity25List.this, getResources().getString(R.string.play), FloatingToast.LENGTH_TOO_LONG)
                            .setGravity(FloatingToast.GRAVITY_BOTTOM)
                            .setFadeOutDuration(FloatingToast.FADE_DURATION_TOO_LONG)
                            .setTextSizeInDp(getResources().getDimensionPixelSize(R.dimen._9mdp))
                            .setTextTypeface(Typeface.createFromAsset(getAssets(), "fonts/toto.ttf"))
                            ...
                            .setShadowLayer(5, 1, 1, Color.parseColor("#C1395E"))
                            .show();    //Show toast at the specified fixed position
        ...
        shapeDrawable.setColor(getResources().getColor(R.color.shape25));
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                CookieBar.build(Activity25List.this)
                        .setTitle(getResources().getString(R.string.hold_button_to_record))
                        .setTitleColor(R.color.al2525)
                        ...
                        .setBackgroundColor(R.color.al25252525)
            ...
            public void onFinish(long recordTime) {
                ...
                new MaterialToast(context)
                        ...
                        .setBackgroundColor(getResources().getColor(R.color.shape25))
                        .show();
        ...
        kal7 = findViewById(R.id.kal7); kal8 = findViewById(R.id.kal8); badge = findViewById(R.id.badge);
        ...
        new ClickShrinkEffect(badge); new ClickShrinkEffect(img1);
