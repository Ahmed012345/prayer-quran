package com.zaker.android.sapeh.app.main.activitymain.expandingcards.view;
...
public class ItemsCountView extends LinearLayout {
    ...
    private TextView createViewForTextSwitcher(Context context) {
        ...
        textView.setLayoutParams(new TextSwitcher.LayoutParams(TextSwitcher.LayoutParams.WRAP_CONTENT,
