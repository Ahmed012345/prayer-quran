package com.zaker.android.sapeh.app.main.aboutpage;
 ...
 * an About page. This class creates a {@link View} that can be passed as the root view
...
public class AboutPage {
    ...
    public AboutPage addMoreAppsFromUs(String id) {
        return addMoreAppsFromUs(id, mContext.getString(R.string.about_play_store2));
    }




    public AboutPage addMoreAppsFromUs(String id, String title) {
        Element moreAppsFromUs = new Element();
        moreAppsFromUs.setTitle(title);
        moreAppsFromUs.setIconDrawable(R.drawable.about_apps_from_us);
        moreAppsFromUs.setIconTint(R.color.btnRequest);
        moreAppsFromUs.setValue(id);

        Uri uri = Uri.parse("market://details?id=" + id);
        Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        moreAppsFromUs.setIntent(goToMarket);

        addItem(moreAppsFromUs);
        return this;
    }
     ...
     */
    public View create() {
        LinearLayout description =  mView.findViewById(R.id.description);
