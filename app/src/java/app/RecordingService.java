...
public class RecordingService extends Service {
	...
	private final static String CHANNEL_ID = "com.zaker.android.sapeh.NotificationId";

	private final static String CHANNEL_NAME_ERRORS = "Errors";
	private final static String CHANNEL_ID_ERRORS = "com.zaker.android.sapeh.Errors";
...
//		remoteViewsBig.setInt(R.id.container, "setBackgroundColor", this.getResources().getColor(colorMap.getPrimaryColorRes()));
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			...
			builder.setSmallIcon(R.drawable.ic_rec_redsmall);
		}
...
//		builder.setCustomBigContentView(remoteViewsBig);
	...
	private PendingIntent createContentIntent() {
		...
		Intent intent = new Intent(getApplicationContext(), MainRecActivity.class);
